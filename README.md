...
[![Commercial License Available](https://img.shields.io/badge/Commercial%20License-Available-green.svg)](mailto:serhodg12@gmail.com)
...
Цей проект доступний під двома ліцензіями:

### Відкрита ліцензія (AGPL v3)

Mentorly є програмним забезпеченням з відкритим вихідним кодом під ліцензією [GNU Affero General Public License v3.0](LICENSE).

Ви можете вільно використовувати, вивчати та модифікувати цей код **за умови**, що будь-які похідні роботи або розгортання, що надають доступ до системи через мережу, також публікуються під AGPL v3.

### Комерційна ліцензія

Якщо ви бажаєте використовувати Mentorly **комерційно** (продавати, розгортати як платний сервіс або інтегрувати у власний продукт) без дотримання вимог AGPL v3 щодо розкриття вихідного коду — зверніться для отримання комерційної ліцензії:

**Email:** serhodg12@gmail.com

> Комерційна ліцензія надає право на розгортання системи в навчальних закладах без зобов'язання відкривати власні модифікації.
