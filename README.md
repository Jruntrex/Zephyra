# Zephyra — Платформа управління навчальним процесом

**Zephyra** — головна платформа для автоматизації академічного обліку. Кожен навчальний заклад розгортає власний екземпляр Zephyra зі своїм брендингом — у даному репозиторії це заклад **MyBosco**.
...
- Система сповіщень (прочитано / непрочитано)
